...
export function LoginView() {
     ...
     const handleSubmit = (e) => {
          e.preventDefault();
          setUser(e.target.username.value, e.target.password.value);
     }
          ...
          <section className=" flex flex-col items-center w-full gap-8">
               ...
               <form onSubmit={handleSubmit} className="flex flex-col w-full max-w-screen-sm gap-4">
                    <label className="flex flex-col w-full" >
                         Username:
                         <input type="text" name="username" className="px-4 py-2 border" placeholder="Patrocleo" />
                    </label>
                    <label className="flex flex-col w-full" >
                         Password:
                         <input type="password" name="password" className="px-4 py-2 border" placeholder="*********" />
                    </label>
